...
terminal_vblank:
    ...
    mov %bc, 0x6B00
    and %bc, $32
    jrz __terminal_vblank__no_showcursor
    mov %bc, 0x6B02
    add %bc, $0x6C00
    __terminal_vblank__no_showcursor:
    __terminal_vblank__loop:
        cmp %xl, %bc
        jrz __terminal_vblank__loop_cursor
            mov %n, (%xl)
        __terminal_vblank__loop_cursor_end:
        mov 0x7F9A, %n
        inc %xl
        cmp %xl, $0x7000
    ...
    pop %xl
    ret
    __terminal_vblank__loop_cursor:
        mov %n, $0x05
    jr __terminal_vblank__loop_cursor_end
